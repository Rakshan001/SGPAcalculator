function calculate_SGPA() {
    ...
    var total_credit = credit1 + credit2 + credit3 + credit4 + credit5 + credit6;
    var total_points = (credit1 * point1) + (credit2 * point2) + (credit3 * point3) + (credit4 * point4) + (credit5 * point5) + (credit6 * point6);
